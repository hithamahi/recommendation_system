...
movies = pickle.load(open(r"C:\tried project with links\artifacts\movies.pkl",'rb'))
similarity = pickle.load(open(r"C:\tried project with links\artifacts\similarity.pkl",'rb'))
